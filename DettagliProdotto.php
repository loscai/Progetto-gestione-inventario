...
<body>
    ...
    <div style="max-width: 50%;">
        <img src="<?php echo $prodottoSelezionato->getPathImmagine(); ?>"
            alt="<?php echo $prodottoSelezionato->getNome(); ?>" style="max-width: 50%; max-height: 50%;">
    ...
    <!-- QUA BISOGNA MANDARE L'UTENTE ALLA !!!SUA!!! HOMEPAGE, NON A QUELLA GENERICA, 
         SENNO' SALTANO DELLE DIRECTORY E POI NON HA SENSO-->
    <?php
    
    //RECUPERATI L'UTENTE LOGGATO E TORNA ALLA SUA HOMEPAGE
